...
DelegateU5BU5D_tC5AB7E8F745616680F337909D3A8E6C722CDF771* delegateArrayToInvoke = __this->___delegates_13;
	...
	for (il2cpp_array_size_t i = 0; i < length; i++)
	{
		...
		if (___methodIsStatic)
		{
			...
			{
				// open
				InvokerActionInvoker1< bool >::Invoke(targetMethodPointer, targetMethod, NULL, ___deviceWasChanged0);
			}
			else
			{
				// closed
				InvokerActionInvoker2< RuntimeObject*, bool >::Invoke(targetMethodPointer, targetMethod, NULL, targetThis, ___deviceWasChanged0);
			}
		}
		else
		{
			...
			{
				InvokerActionInvoker1< bool >::Invoke(targetMethodPointer, targetMethod, targetThis, ___deviceWasChanged0);
			}
		}
	}
}
...
DelegateU5BU5D_tC5AB7E8F745616680F337909D3A8E6C722CDF771* delegateArrayToInvoke = __this->___delegates_13;
	...
	for (il2cpp_array_size_t i = 0; i < length; i++)
	{
		...
		if (___methodIsStatic)
		{
			...
			{
				// open
				InvokerActionInvoker1< SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C* >::Invoke(targetMethodPointer, targetMethod, NULL, ___data0);
			}
			else
			{
				// closed
				InvokerActionInvoker2< RuntimeObject*, SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C* >::Invoke(targetMethodPointer, targetMethod, NULL, targetThis, ___data0);
			}
		}
			...
			if (currentDelegate->___method_is_virtual_12)
			{
				if (il2cpp_codegen_method_is_generic_instance(targetMethod))
				{
					if (il2cpp_codegen_method_is_interface_method(targetMethod))
						GenericInterfaceActionInvoker0Invoker::Invoke(targetMethod, (RuntimeObject*)___data0);
					else
						GenericVirtualActionInvoker0Invoker::Invoke(targetMethod, (RuntimeObject*)___data0);
				}
				else
				{
					if (il2cpp_codegen_method_is_interface_method(targetMethod))
						InterfaceActionInvoker0Invoker::Invoke(il2cpp_codegen_method_get_slot(targetMethod), il2cpp_codegen_method_get_declaring_type(targetMethod), (RuntimeObject*)___data0);
					else
						VirtualActionInvoker0Invoker::Invoke(il2cpp_codegen_method_get_slot(targetMethod), (RuntimeObject*)___data0);
				}
			}
			else
			{
				InvokerActionInvoker0::Invoke(targetMethodPointer, targetMethod, ___data0);
			}
		}
		else
		{
			...
			{
				InvokerActionInvoker1< SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C* >::Invoke(targetMethodPointer, targetMethod, targetThis, ___data0);
			}
		}
	}
}
...
DelegateU5BU5D_tC5AB7E8F745616680F337909D3A8E6C722CDF771* delegateArrayToInvoke = __this->___delegates_13;
	...
	for (il2cpp_array_size_t i = 0; i < length; i++)
	{
		...
		if (___methodIsStatic)
		{
			...
			{
				// open
				InvokerActionInvoker1< int32_t >::Invoke(targetMethodPointer, targetMethod, NULL, ___position0);
			}
			else
			{
				// closed
				InvokerActionInvoker2< RuntimeObject*, int32_t >::Invoke(targetMethodPointer, targetMethod, NULL, targetThis, ___position0);
			}
		}
		else
		{
			...
			{
				InvokerActionInvoker1< int32_t >::Invoke(targetMethodPointer, targetMethod, targetThis, ___position0);
			}
		}
	}
}
...
DelegateU5BU5D_tC5AB7E8F745616680F337909D3A8E6C722CDF771* delegateArrayToInvoke = __this->___delegates_13;
	...
	for (il2cpp_array_size_t i = 0; i < length; i++)
	{
		...
		if (___methodIsStatic)
		{
			...
			{
				// open
				InvokerActionInvoker2< AudioSampleProvider_t602353124A2F6F2AEC38E56C3C21932344F712E2*, uint32_t >::Invoke(targetMethodPointer, targetMethod, NULL, ___provider0, ___sampleFrameCount1);
			}
			else
			{
				// closed
				InvokerActionInvoker3< RuntimeObject*, AudioSampleProvider_t602353124A2F6F2AEC38E56C3C21932344F712E2*, uint32_t >::Invoke(targetMethodPointer, targetMethod, NULL, targetThis, ___provider0, ___sampleFrameCount1);
			}
		}
		else if (___parameterCount != 2)
		{
			...
			if (currentDelegate->___method_is_virtual_12)
			{
				...
				{
					if (il2cpp_codegen_method_is_interface_method(targetMethod))
						GenericInterfaceActionInvoker1Invoker< uint32_t >::Invoke(targetMethod, (RuntimeObject*)___provider0, ___sampleFrameCount1);
					else
						GenericVirtualActionInvoker1Invoker< uint32_t >::Invoke(targetMethod, (RuntimeObject*)___provider0, ___sampleFrameCount1);
				}
				else
				{
					if (il2cpp_codegen_method_is_interface_method(targetMethod))
						InterfaceActionInvoker1Invoker< uint32_t >::Invoke(il2cpp_codegen_method_get_slot(targetMethod), il2cpp_codegen_method_get_declaring_type(targetMethod), (RuntimeObject*)___provider0, ___sampleFrameCount1);
					else
						VirtualActionInvoker1Invoker< uint32_t >::Invoke(il2cpp_codegen_method_get_slot(targetMethod), (RuntimeObject*)___provider0, ___sampleFrameCount1);
				}
			}
			else
			{
				InvokerActionInvoker1< uint32_t >::Invoke(targetMethodPointer, targetMethod, ___provider0, ___sampleFrameCount1);
			}
		}
		else
		{
			...
			{
				InvokerActionInvoker2< AudioSampleProvider_t602353124A2F6F2AEC38E56C3C21932344F712E2*, uint32_t >::Invoke(targetMethodPointer, targetMethod, targetThis, ___provider0, ___sampleFrameCount1);
			}
		}
	}
}
