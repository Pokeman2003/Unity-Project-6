...
--Note by Bitl: This was slightly modified so that it is more compatable with older clients. You can now also easily swap out the URL in case the URL breaks over time. I also added more URL variants.
...
local converturl = "http://%epicgamers%.xyz/asset/%?id="
